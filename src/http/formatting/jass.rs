        ...
        if !text.ends_with('\n') {
            ...
            edits.push(TextEdit {
                range: crate::http::range::Range {
                    start: crate::http::position::Position { line: last_line, character: last_line_utf16 },
                    end: crate::http::position::Position { line: last_line, character: last_line_utf16 },
                },
                new_text: "\n".to_string(),
            });
        }
...
fn ensure_gap(
    ...
    edits.push(TextEdit {
        range: crate::http::range::Range {
            start: crate::http::position::Position {
                line,
                character: utf16_start,
            },
            end: crate::http::position::Position {
                line,
                character: utf16_end,
            },
        },
